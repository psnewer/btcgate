...
#            FH.balance = False
#            FH.S_dn = FH.S_
#            FH.S_dn_t = -FH.rt_soft_max/(1.0-FH.rt_soft_max*(1.0-FH.t)) if FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#            FH.S_up = FH.rt_soft_med/(1.0+FH.rt_soft_med*(1.0-FH.t))
#            FH.S_up_t = 2*FH.rt_soft_med/(1.0+2*FH.rt_soft_med*(1.0-FH.t))
#        else:
...
#                    FH.catch = True
#                    FH.S_up = FH.S_
#                    FH.S_up_t = ((1.0-FH.rt_soft_med)*FH.S_+FH.rt_soft_med*FH._T)/(1.0+FH.rt_soft_med*(1.0-FH.t))
#                    FH.S_dn = ((1.0+FH.rt_soft_max)*FH.S_-FH.rt_soft_max*FH._T)/(1.0-FH.rt_soft_max*(1.0-FH.t)) if FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                    FH.S_dn_t = ((1.0+2*FH.rt_soft_max)*FH.S_-2*FH.rt_soft_max*FH._T)/(1.0-2*FH.rt_soft_max*(1.0-FH.t)) if 2*FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                elif FH.t <= FH.t_dn_S:
#                    FH.balance = False
#                    FH.catch = True
#                    FH.S_dn = FH.S_
#                    FH.S_dn_t = ((1.0+FH.rt_soft_max)*FH.S_-FH.rt_soft_max*FH._T)/(1.0-FH.rt_soft_max*(1.0-FH.t)) if FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                    FH.S_up = ((1.0-FH.rt_soft_med)*FH.S_+FH.rt_soft_med*FH._T)/(1.0+FH.rt_soft_med*(1.0-FH.t))
#                    FH.S_up_t = ((1.0-2*FH.rt_soft_med)*FH.S_+2*FH.rt_soft_med*FH._T)/(1.0+2*FH.rt_soft_med*(1.0-FH.t))
...
#                    FH.balance = True
#                    FH.t_up = FH.t
#                    FH.t_dn = ((1.0+FH.rt_soft_max)*FH.t-FH.rt_soft_max)/(1.0-FH.rt_soft_max*(1.0-FH.t)) if FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                    FH.t_up_S = ((1.0-FH.rt_soft_med)*FH.t+FH.rt_soft_med)/(1.0+FH.rt_soft_med*(1.0-FH.t))
#                    FH.t_dn_S = ((1.0+2*FH.rt_soft_max)*FH.t-2*FH.rt_soft_max)/(1.0-2*FH.rt_soft_max*(1.0-FH.t)) if 2*FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                elif FH.S_ <= FH.S_dn_t:
#                    FH.catch = False
#                    FH.balance = True
#                    FH.t_dn = FH.t
#                    FH.t_up = ((1.0-FH.rt_soft_med)*FH.t+FH.rt_soft_med)/(1.0+FH.rt_soft_med*(1.0-FH.t))
#                    FH.t_dn_S = ((1.0+FH.rt_soft_max)*FH.t-FH.rt_soft_max)/(1.0-FH.rt_soft_max*(1.0-FH.t)) if FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
#                    FH.t_up_S = ((1.0-2*FH.rt_soft_med)*FH.t+2*FH.rt_soft_med)/(1.0+2*FH.rt_soft_med*(1.0-FH.t))
...
#                FH.t_dn_S = ((1.0+2*FH.rt_soft_max)*FH.t-2*FH.rt_soft_max)/(1.0-2*FH.rt_soft_max*(1.0-FH.t)) if 2*FH.step_soft_max < -min(FH.t_f,FH.t_b) else -1.0
        ...
        if FH.forward_position_size == 0 or FH.backward_position_size == 0:
            ...
            FH.balance = False
            FH.S_dn = FH.S_
            FH.S_dn_t = -FH.rt_soft/(1.0-FH.rt_soft*(1.0-FH.t)) if FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
            FH.S_up = FH.rt_soft/(1.0+FH.rt_soft*(1.0-FH.t))
            FH.S_up_t = 2*FH.rt_soft/(1.0+2*FH.rt_soft*(1.0-FH.t))
        else:
            if FH.balance and not FH.catch:
#                FH.t_up = min(FH.t_up,(1.0-FH.rt_soft)*FH.t+FH.rt_soft)
#                FH.t_up_S = min(FH.t_up_S,(1.0-2*FH.rt_soft)*FH.t+2*FH.rt_soft)
...
#                FH.t_dn_S = max(FH.t_dn_S,(1.0+2*FH.rt_soft)*FH.t-2*FH.rt_soft)
                if FH.t >= FH.t_up_S:
                    ...
                    FH.catch = True
                    FH.S_up = FH.S_
                    FH.S_up_t = ((1.0-FH.rt_soft)*FH.S_+FH.rt_soft*FH._T)/(1.0+FH.rt_soft*(1.0-FH.t))
                    FH.S_dn = ((1.0+FH.rt_soft)*FH.S_-FH.rt_soft*FH._T)/(1.0-FH.rt_soft*(1.0-FH.t)) if FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                    FH.S_dn_t = ((1.0+2*FH.rt_soft)*FH.S_-2*FH.rt_soft*FH._T)/(1.0-2*FH.rt_soft*(1.0-FH.t)) if 2*FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                elif FH.t <= FH.t_dn_S:
                    FH.balance = False
                    FH.catch = True
                    FH.S_dn = FH.S_
                    FH.S_dn_t = ((1.0+FH.rt_soft)*FH.S_-FH.rt_soft*FH._T)/(1.0-FH.rt_soft*(1.0-FH.t)) if FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                    FH.S_up = ((1.0-FH.rt_soft)*FH.S_+FH.rt_soft*FH._T)/(1.0+FH.rt_soft*(1.0-FH.t))
                    FH.S_up_t = ((1.0-2*FH.rt_soft)*FH.S_+2*FH.rt_soft*FH._T)/(1.0+2*FH.rt_soft*(1.0-FH.t))
                print ('balance',FH.t,FH.t_up_S,FH.t_up,FH.t_dn,FH.t_dn_S)
            elif not FH.balance and FH.catch:
#                FH.S_up = min(FH.S_up,(1.0-FH.rt_soft)*FH.S_+FH.rt_soft*FH._T)
#                FH.S_up_t = min(FH.S_up_t,(1.0-2*FH.rt_soft)*FH.S_+2*FH.rt_soft*FH._T)
...
#                FH.S_dn_t = max(FH.S_dn_t,(1.0+2*FH.rt_soft)*FH.S_-2*FH.rt_soft*FH._T)
                if FH.S_ >= FH.S_up_t:
                    ...
                    FH.balance = True
                    FH.t_up = FH.t
                    FH.t_dn = ((1.0+FH.rt_soft)*FH.t-FH.rt_soft)/(1.0-FH.rt_soft*(1.0-FH.t)) if FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                    FH.t_up_S = ((1.0-FH.rt_soft)*FH.t+FH.rt_soft)/(1.0+FH.rt_soft*(1.0-FH.t))
                    FH.t_dn_S = ((1.0+2*FH.rt_soft)*FH.t-2*FH.rt_soft)/(1.0-2*FH.rt_soft*(1.0-FH.t)) if 2*FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                elif FH.S_ <= FH.S_dn_t:
                    FH.catch = False
                    FH.balance = True
                    FH.t_dn = FH.t
                    FH.t_up = ((1.0-FH.rt_soft)*FH.t+FH.rt_soft)/(1.0+FH.rt_soft*(1.0-FH.t))
                    FH.t_dn_S = ((1.0+FH.rt_soft)*FH.t-FH.rt_soft)/(1.0-FH.rt_soft*(1.0-FH.t)) if FH.step_soft < -min(FH.t_f,FH.t_b) else -1.0
                    FH.t_up_S = ((1.0-2*FH.rt_soft)*FH.t+2*FH.rt_soft)/(1.0+2*FH.rt_soft*(1.0-FH.t))
                print ('catch',FH.S_,FH.S_up_t,FH.S_up,FH.S_dn,FH.S_dn_t)
            elif not FH.balance and not FH.catch:
                FH.balance = True
                FH.t_up = ((1.0-FH.rt_soft)*FH.t+FH.rt_soft)/(1.0+FH.rt_soft*(1.0-FH.t))
        ...
        if FH.balance:
            if FH.forward_gap < 0.0 and FH.backward_gap >= 0.0:
                ...
                elif FH.backward_stable_price and FH._T > self.T_std:
                    if FH.t >= FH.t_up:
                ...
                if FH.backward_stable_price and FH._T < self.T_std:
                    if FH.t <= FH.t_dn:
                        self.backward_gap_balance = True
                elif FH.forward_stable_price and FH._T > self.T_std:
                    if FH.t >= FH.t_up:
                        self.forward_gap_balance = True
            elif FH.forward_gap < 0.0 and FH.backward_gap < 0.0:
                if FH.forward_gap > FH.backward_gap:
    ...
    #                self.backward_gap_balance = True
        ...
        if self.forward_gap_balance:
            if FH.forward_gap >= 0.0:
                if FH.backward_gap < 0.0:
                    self.forward_balance_size = int(max(-FH.forward_position_size-FH.backward_position_size*self.T_std,-FH.forward_position_size))
                    print ('d1',-FH.forward_position_size-FH.backward_position_size*self.T_std,-FH.forward_position_size)
                else:
                    self.forward_balance_size = int(-FH.forward_position_size - FH.backward_position_size*self.T_std)
            else:
                if FH.backward_gap >= 0.0:
                    self.forward_balance_size = int(max(-FH.backward_position_size/self.T_std-FH.forward_position_size,FH.forward_position_size*FH.balance_overflow/FH.forward_goods))
                    print ('d2',-FH.backward_position_size/self.T_std-FH.forward_position_size,FH.forward_position_size*FH.balance_overflow/FH.forward_goods)
                else:
                    self.forward_balance_size = int(max(-FH.backward_position_size/self.T_std-FH.forward_position_size,FH.forward_position_size*FH.balance_overflow/FH.forward_goods))
                    print ('d2',-FH.backward_position_size/self.T_std-FH.forward_position_size,FH.forward_position_size*FH.balance_overflow/FH.forward_goods)
        if self.backward_gap_balance:
            if FH.backward_gap >= 0.0:
                if FH.forward_gap < 0.0:
                    self.backward_balance_size = int(min(-FH.backward_position_size-FH.forward_position_size*self.T_std,-FH.backward_position_size))
                    print ('d3',-FH.backward_position_size-FH.forward_position_size*self.T_std,-FH.backward_position_size)
                else:
                    self.backward_balance_size = int(-FH.backward_position_size - FH.forward_position_size*self.T_std)
            else:
                if FH.forward_gap >= 0.0:
                    self.backward_balance_size = int(min(-FH.forward_position_size/self.T_std-FH.backward_position_size,FH.backward_position_size*FH.balance_overflow/FH.backward_goods))
                    print ('d4',-FH.forward_position_size/self.T_std-FH.backward_position_size,FH.backward_position_size*FH.balance_overflow/FH.backward_goods)
                else:
                    self.backward_balance_size = int(min(-FH.forward_position_size/self.T_std-FH.backward_position_size,FH.backward_position_size*FH.balance_overflow/FH.backward_goods))
                    print ('d4',-FH.forward_position_size/self.T_std-FH.backward_position_size,FH.backward_position_size*FH.balance_overflow/FH.backward_goods)
            ...
            if FH.forward_gap < 0.0 and FH.backward_gap >= 0.0:
                if FH._T > self.T_std:
                    if FH.backward_stable_price and FH.S_ >= FH.S_up:
                        ...
                        print ('1111',-FH.backward_position_size/self.T_std-FH.forward_position_size,FH.forward_limit-FH.forward_position_size)
                elif FH._T < self.T_std:
                ...
                if FH._T > self.T_std:
                    if FH.forward_stable_price and FH.S_ >= FH.S_up:
                        self.backward_catch = True
                        self.backward_catch_size = int(max(-FH.forward_position_size/self.T_std-FH.backward_position_size,-FH.backward_limit-FH.backward_position_size))
                        print ('2222',-FH.forward_position_size/self.T_std-FH.backward_position_size,-FH.backward_limit-FH.backward_position_size)
                elif FH._T < self.T_std:
